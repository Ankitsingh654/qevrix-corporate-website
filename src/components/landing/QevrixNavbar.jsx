        ...
        <div className={`flex justify-between items-center transition-all duration-300 ${scrolled ? 'h-16' : 'h-24'}`}>
          <div className="flex items-center space-x-12">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/careers" className="relative text-sm font-semibold text-white/80 hover:text-white transition-colors py-8 group">
                Careers
                {isActive('/careers') && (
                  <motion.div layoutId="nav-underline" className="absolute bottom-6 left-0 w-full h-[2px] bg-qx-primary rounded-full shadow-[0_0_10px_rgba(59,130,246,0.8)]" />
                )}
                {!isActive('/careers') && <div className="absolute bottom-6 left-0 w-0 h-[2px] bg-white/30 rounded-full group-hover:w-full transition-all duration-300" />}
              </Link>
        ...
        {isOpen && (
          ...
          >
            <div className="px-6 py-6 space-y-6 flex flex-col max-h-[85vh] overflow-y-auto">
              ...
              <Link to="/careers" className="text-base font-semibold text-white" onClick={() => setIsOpen(false)}>Careers</Link>
